 ...
 *    return.
 *
 * 2. `isPrivate` (boolean), `tags` (array of objects),`text` (string), and
 *    group (string), which are the user's draft changes to the annotation.
 *    These are returned from the drafts service by `drafts.get()`.
 *
 */
function DraftStore() {
  this._drafts = [];
