...
describe('tabCounts', function () {
  ...
  it('counts Annotations and Orphans separately when the Orphans tab is not enabled', function () {
  ...
  it('counts Annotations and Orphans together when the Orphans tab is enabled', function () {
